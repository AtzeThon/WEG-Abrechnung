"""Referenzdatensatz zur Validierung der Berechnungs-Engine.

Struktur, Beträge und Miteigentumsanteile stammen aus einer realen Jahresabrechnung
(Wirtschaftsjahr 01.08.2025 – 31.07.2026) und reproduzieren deren Ergebniszahlen
Cent-genau. **Namen von Zahlungspartnern/Lieferanten sind durch neutrale Platzhalter
ersetzt** – echte Stammdaten werden ausschließlich lokal (UI bzw. nicht eingecheckte
Seed-Datei) erfasst.

Der Datensatz wird vom Engine-Test (``tests/test_engine.py``) und vom Demo-Seed
(``scripts/seed_2026.py``) verwendet.
"""
...
# Girokonto-Anfangssaldo laut Kontoauszug. In der Excel wird daraus der Saldovortrag
...
COST_TYPES: list[CostTypeInput] = [
    ...
    CostTypeInput("Zählermiete und Messdienst", "betriebskosten", "mea", _HWB, "Messdienstleister"),
    CostTypeInput("Abschlag - Gas, Strom, Wasser", "betriebskosten", "vorauszahlung", _HWB, "Stadtwerke"),
    CostTypeInput("Haftpflicht", "betriebskosten", "mea", _VERS, "Gebäudeversicherer"),
    CostTypeInput("Gebäudeversicherung", "betriebskosten", "mea", _VERS, "Gebäudeversicherer"),
    CostTypeInput("Vermögenschadenhaftpflicht", "betriebskosten", "mea", _VERS, "Gebäudeversicherer"),
    CostTypeInput("Grundbesitzabgaben", "betriebskosten", "mea", _GEB, "Kommune"),
    CostTypeInput("Bankgebühren", "betriebskosten", "mea", _GEB, "Bank"),
    CostTypeInput("Schornsteinfeger", "betriebskosten", "mea", _WART, "Bezirksschornsteinfeger"),
    CostTypeInput("Heizungswartung", "betriebskosten", "mea", _WART, "Heizungsfachbetrieb"),
    CostTypeInput("Gehwegreinigung", "betriebskosten", "mea", _WART, "Hausmeisterdienst"),
    CostTypeInput("Gartenpflege", "betriebskosten", "mea", _WART, "Gartenpflege-Betrieb"),
    ...
    CostTypeInput("Heizungseinbau", "investition", "mea", "sonstiges", "Heizungsbaubetrieb"),
]
...
_RAW_TX: list[tuple] = [
    ...
    (45881, "Messdienstleister", None, "Zählermiete und Messdienst", -782.9),
    (45883, "Hausmeisterdienst", None, "Gehwegreinigung", -83.18),
    (45883, "Kommunalkasse", None, "Grundbesitzabgaben", -241.95),
    (45884, "Stadtwerke", None, "Abschlag - Gas, Strom, Wasser", -510),
    (45900, "Bank", None, "Bankgebühren", -19.1),
    ...
    (45915, "Hausmeisterdienst", None, "Gehwegreinigung", -83.18),
    (45915, "Stadtwerke", None, "Abschlag - Gas, Strom, Wasser", -510),
    (45930, "Eigentümergemeinschaft", "E3", "Hausgeld", 160),
    (45930, "Bank", None, "Bankgebühren", -20.22),
    (45931, "Gebäudeversicherer", None, "Haftpflicht", -159.58),
    (45931, "Gebäudeversicherer", None, "Gebäudeversicherung", -1626.6),
    ...
    (45944, "Hausmeisterdienst", None, "Gehwegreinigung", -83.18),
    (45945, "Stadtwerke", None, "Abschlag - Gas, Strom, Wasser", -510),
    (45960, "Eigentümergemeinschaft", "E3", "Hausgeld", 160),
    (45960, "Bank", None, "Bankgebühren", -2.5),
    (45961, "Bank", None, "Bankgebühren", -16.94),
    ...
    (45973, "Heizungsfachbetrieb", None, "Heizungswartung", -343.01),
    (45978, "Hausmeisterdienst", None, "Gehwegreinigung", -83.18),
    (45978, "Kommunalkasse", None, "Grundbesitzabgaben", -242.01),
    (45978, "Stadtwerke", None, "Abschlag - Gas, Strom, Wasser", -510),
    (45991, "Bank", None, "Bankgebühren", -19.38),
    ...
    (46006, "Hausmeisterdienst", None, "Gehwegreinigung", -83.18),
    (46006, "Stadtwerke", None, "Abschlag - Gas, Strom, Wasser", -510),
    (46008, "Eigentümergemeinschaft", "E2", "Erstattung/Nachzahlung", 2369.08),
    (46009, "Gartenpflege-Betrieb", None, "Gartenpflege", -587.86),
    (46021, "Eigentümergemeinschaft", "E3", "Hausgeld", 180),
    (46022, "Bank", None, "Bankgebühren", -18.14),
    ...
    (46045, "Hausmeisterdienst", None, "Gehwegreinigung", -86.67),
    ...
    (46052, "Bank", None, "Bankgebühren", -19.02),
    (46055, "Eigentümergemeinschaft", "E2", "Hausgeld", 390),
    (46055, "Eigentümergemeinschaft", "E1", "Hausgeld", 260),
    (46062, "Kommunalkasse", None, "Grundbesitzabgaben", -295.59),
    (46062, "Eigentümergemeinschaft", "E4", "Hausgeld", 188.5),
    (46070, "Hausmeisterdienst", None, "Gehwegreinigung", -86.67),
    (46080, "Bank", None, "Bankgebühren", -16.1),
    ...
    (46093, "Heizungsbaubetrieb", None, "Heizungseinbau", -13050.81),
    (46098, "Hausmeisterdienst", None, "Gehwegreinigung", -86.67),
    (46108, "Eigentümergemeinschaft", "E4", "Hausgeld", 377),
    (46111, "Eigentümergemeinschaft", "E3", "Hausgeld", 180),
    (46111, "Bank", None, "Bankgebühren", -19.38),
    (46113, "Eigentümergemeinschaft", "E2", "Hausgeld", 390),
    (46113, "Eigentümergemeinschaft", "E1", "Hausgeld", 260),
    (46129, "Hausmeisterdienst", None, "Gehwegreinigung", -86.67),
    (46142, "Eigentümergemeinschaft", "E3", "Hausgeld", 180),
    (46142, "Bank", None, "Bankgebühren", -15.82),
    (46143, "Eigentümergemeinschaft", "E1", "Hausgeld", 260),
    (46146, "Heizungsbaubetrieb", None, "Heizungseinbau", -2785.77),
    (46146, "Eigentümergemeinschaft", "E2", "Hausgeld", 390),
    (46156, "Hausmeisterdienst", None, "Gehwegreinigung", -86.67),
    (46157, "Kommunalkasse", None, "Grundbesitzabgaben", -295.59),
    (46161, "Eigentümergemeinschaft", "E4", "Hausgeld", 188.5),
    (46171, "Bank", None, "Bankgebühren", -19.1),
    ...
    (46188, "Hausmeisterdienst", None, "Gehwegreinigung", -86.67),
    (46188, "Gebäudeversicherer", None, "Vermögenschadenhaftpflicht", -149.94),
    (46203, "Stadtwerke", None, "Abschlag - Gas, Strom, Wasser", -231.46),
    (46203, "Eigentümergemeinschaft", "E3", "Hausgeld", 180),
    (46203, "Bank", None, "Bankgebühren", -19.66),
    (46204, "Eigentümergemeinschaft", "E2", "Hausgeld", 390),
    (46204, "Eigentümergemeinschaft", "E1", "Hausgeld", 260),
    (46218, "Stadtwerke", None, "Abschlag - Gas, Strom, Wasser", -745),
    (46220, "Hausmeisterdienst", None, "Gehwegreinigung", -86.67),
    (46234, "Bank", None, "Bankgebühren", -15.82),
